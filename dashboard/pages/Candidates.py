"""
This page displays a list of candidates based on various filters and anomaly scores.
...
view_df = df_selected[["Test", "TestKey", "CandidateKey", "InstanceID", 
...
if len(streamlit_df.selection.rows)>0:
    ...
    st.session_state['candidate_key'] = view_df.iloc[selected_row_index]['CandidateKey']
    st.switch_page("pages/Search_Candidate.py")
